...
import { contas, webhooks, verificacoes, logsExternos, pedidosLgpd, campanhasGolpe, telefones, auditoria, alvos, alvoHistorico, empresaDocumentos, empresas, contestacoes, empresaDominios, admins, telefoneRelatos, contestacaoMensagens, denuncias, golpesConhecidos, codigosReserva, emails, tickets, sessoes, tokens, assinaturas, pagamentos, membros, verificacaoItens, monitoramentos, apiChaves, ticketMensagens, empresaEventos, contestacaoAnexos, denunciaProvas, imagens, planos, usoMensal } from "./schema";
